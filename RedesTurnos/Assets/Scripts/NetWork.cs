...
public class Network : MonoBehaviour
{
    ...
    public List<GameObject> damasNoTabuleiro;
    ...
    void Start()
    {
        ...
        Tabuleiro = GameObject.FindGameObjectWithTag("Tabuleiro").GetComponent<Tabuleiro>();
        foreach (GameObject damaB in Tabuleiro.pecasBrancas)
        {
            damasNoTabuleiro.Add(damaB);
        }
        foreach (GameObject damaP in Tabuleiro.pecasPretas)
        {
            damasNoTabuleiro.Add(damaP);
        }
    }
    ...
    void HandleMessage(string msg)
    {
        if(msg == "LIGHT_ON")
        {
            //MainThreadAction(() => remoteCube.SetActive(true));
        }

        if(msg == "LIGHT_OFF")
        {
            //MainThreadAction(() => remoteCube.SetActive(false));
        }
    }
